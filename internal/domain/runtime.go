...
type Progress struct {
	...
	// ReopenCount records explicit user reopen actions and changes progress.json
	// so completing a reopened book is not deduplicated against its prior checkpoint.
